...
object R2RMLMappingDocument {
  ...
  def apply(mdPath: String, props: MorphProperties, connection: Connection): R2RMLMappingDocument = {
    ...
    // And build a list of instances of R2RMLTriplesMap in which id is the name of the triples map local name (like #MyTiplesMap) 
    ...
    // From the list of triples maps create an R2RML mapping document
