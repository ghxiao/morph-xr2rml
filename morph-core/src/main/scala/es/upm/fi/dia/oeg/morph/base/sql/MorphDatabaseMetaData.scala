...
class MorphDatabaseMetaData(
        val conn: Connection,
        val dbName: String, val dbType: String,
        var tablesMetaData: List[MorphTableMetaData],
        jdbcDBMetaData: DatabaseMetaData) {
...
object MorphDatabaseMetaData {
    ...
    def apply(conn: Connection, databaseName: String, databaseType: String): MorphDatabaseMetaData = {
