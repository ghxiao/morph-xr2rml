...
abstract class MorphBaseCondSQLGenerator(md: R2RMLMappingDocument, unfolder: MorphBaseUnfolder) {
    ...
    def genCondSQLSubject(tp: Triple, alphaResult: MorphAlphaResult, betaGenerator: MorphBaseBetaGenerator, cm: R2RMLTriplesMap): ZExpression = {
    ...
    def genCondSQLSTG(stg: List[Triple], alphaResult: MorphAlphaResult, betaGenerator: MorphBaseBetaGenerator, cm: R2RMLTriplesMap, mapVarNotNull: Map[Node, Boolean]): MorphCondSQLResult = {
    ...
    private def genCondSQL(tp1: Triple, tp2: Triple, alphaResult: MorphAlphaResult, betaGenerator: MorphBaseBetaGenerator, cm: R2RMLTriplesMap): ZExpression = {
        var exps: Set[ZExpression] = Set.empty;
    ...
    def genCondSQLPredicateObject(tp: Triple, alphaResult: MorphAlphaResult, betaGenerator: MorphBaseBetaGenerator, cm: R2RMLTriplesMap, pm: R2RMLPredicateObjectMap): ZExpression
