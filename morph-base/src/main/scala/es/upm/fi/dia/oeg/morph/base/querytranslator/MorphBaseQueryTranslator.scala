...
abstract class MorphBaseQueryTranslator(
    ...
    private def getMappingDocumentURL(): String = {
    ...
    private def transBGP(bgp: OpBGP): IQuery = {
        val transBGPSQL = {
    ...
    private def transDistinct(opDistinct: OpDistinct): IQuery = {
    ...
    private def transExtend(opExtend: OpExtend): IQuery = {
    ...
    private def transFilter(opFilter: OpFilter): IQuery = {
    ...
    private def transGroup(opGroup: OpGroup): IQuery = {
    ...
    private def transInnerJoin(opJoin: OpJoin): IQuery = {
    ...
    private def transLeftJoin(opLeftJoin: OpLeftJoin): IQuery = {
    ...
    private def transOrder(opOrder: OpOrder): IQuery = {
    ...
    private def transProject(opProject: OpProject): IQuery = {
    ...
    private def transSlice(opSlice: OpSlice): IQuery = {
    ...
    private def transUnion(opUnion: OpUnion): IQuery = {
